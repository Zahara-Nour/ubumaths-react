...
function GidouilleIcon(props) {

  const color = props.color || '#ffc100'
  const size = props.size || '4em'
  return (
    <div style={{...props}}>
    <svg  className={props.className} width={size} height={size} viewBox='0 0 24 24' version='1.1'>
      <path
        style={{
          fill: 'none',
          fillRule: 'evenodd',
